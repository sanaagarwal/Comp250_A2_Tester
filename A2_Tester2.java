...
class Shuffle_Empty implements Runnable{
    ...
    public void run() {
        ...
        if (!(deck.head == null)){
            throw new AssertionError("assignment2.Deck should be empty.");
        }
        System.out.println("assignment2.Test passed.");
    }
}
    ...
    public void run() {
        ...
        for (int i = 0; i < 12; i++) {
            ...
            if (cur.getValue() != expected.getValue()){
                throw new AssertionError("assignment2.Deck is not correctly shuffled.\n" +
...
class Shuffle_SingleCard implements Runnable{
    ...
    public void run() {
        ...
        if (!(deck.head.getValue() == c.getValue() &&
            ...
            throw new AssertionError("assignment2.Deck is not correctly shuffled when it only has one card.");
        }
        System.out.println("assignment2.Test passed.");
    }
}
